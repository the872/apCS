...
//	    order, and some variables are interestingly named :P
	...
	public class Slimeball extends Applet
	    implements Runnable
	{
	    private int nWidth;
	    private int nHeight;
	...
	label0:
	    ...
	    public void paint(Graphics g)
	    {
	        ...
	        if(!fInPlay)
	        {
	            ...
	            g.drawString("Made by Aid Idrizovic", nWidth / 2 - fontmetrics.stringWidth("Made by Aid Idrizovic") / 2, nHeight / 2 + fontmetrics.getHeight() * 2);
	        }
	    }
