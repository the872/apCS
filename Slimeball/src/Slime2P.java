    ...
    implements Runnable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1L; //aid added
	private int nWidth;
    private int nHeight;
    ...
    private String slimeColText[] = {
        "Communist Slime ", "The Green Machine ", "Mr. Chao ", "White Power ", "The Black Mamba "
    };
    private int p1OldX;
    private int p2OldX;
    private int p1OldY;
...
label0:
        ...
        case 503: // Event.MOUSE_MOVE
            showStatus("Slimeball 2-Player, by Aid Idrizovic");
            break;
    ...
    @SuppressWarnings("deprecation") //aid added
	public void paint(Graphics g)
    {
        ...
        if(!fInPlay)
        {
            ...
            screen.setColor(Color.white);
            screen.drawString("Slimeball!", nWidth / 2 - fontmetrics.stringWidth("Slimeball!") / 2, nHeight / 2 - fontmetrics.getHeight());
            g.setColor(Color.white);
            fontmetrics = g.getFontMetrics();
            g.drawString("Written by Aid Idrizovic", nWidth / 2 - fontmetrics.stringWidth("Written by Aid Idrizovic") / 2, nHeight / 2 + fontmetrics.getHeight() * 2);
        }
    }

    @SuppressWarnings("deprecation") //aid entered
	public void destroy()
    {
        gameThread.stop();
        gameThread = null;
    ...
    private void ReplayFrame(int i, int j, int k, int l, int i1, boolean flag)
    {
        ...
        if((i / 10) % 2 > 0)
        {
            ...
            screen.drawString("Treated", j, k); // was Replay...
        } else
        {
            screen.setColor(Color.blue);
